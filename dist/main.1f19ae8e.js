...
console.log(nodes);
dom.attr(test, 'title', 'Hi,I am Frank'); //查
// 看控制台的代码

var title = dom.attr(test, 'title'); // 读
...
console.log(dom.find('.red', test2)[0]); //如果有两个参数，第二个参数表示找的范围

console.log(dom.parent(test));
var s2 = dom.find('#s2')[0];
console.log(dom.siblings(s2));
console.log(dom.next(s2)); //后一个节点

console.log(dom.previous(s2)); //上一个节点
